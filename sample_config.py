...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@RICKTHON")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/rick1128/rickthon1")
    AUTONAME = os.environ.get("AUTONAME", "@rickthon")
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "rickthon")
    THUMB_IMAGE = os.environ.get("THUMB_IMAGE", "https://telegra.ph/file/1830ac434e4dbe94e94a9.jpg")
