...
@iqqhtani.on(admin_cmd(pattern="تحميل صوتي(?:\s|$)([\s\S]*)")
...
@iqqhtani.on(admin_cmd(pattern="تحميل فيديو(?:\s|$)([\s\S]*)")
...
@iqqhtani.on(admin_cmd(pattern="انستا(?: |$)([\s\S]*)")
...
@iqqhtani.on(admin_cmd(pattern="نتائج(?: |$)(\d*)? ?([\s\S]*)")
