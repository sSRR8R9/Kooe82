...
rickthon_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "╮•• مـعلومات الـشخص من بوت ريك ثون "
rickthonM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦"
rickthonF = gvarstatus("CUSTOM_ALIVE_FONT") or "★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★"
...
async def who(event):
    ...
    rickthon = await edit_or_reply(event, "⇆")
    ...
    try:
        ...
        return await edit_or_reply(rickthon, "**- لـم استطـع العثــور ع الشخــص**")
    ...
    try:
        ...
        await rickthon.edit(caption, parse_mode="html")
