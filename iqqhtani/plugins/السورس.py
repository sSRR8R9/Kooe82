...
async def amireallyalive(event):
    ...
    rickthon_ALIVE_TEXT = "❬ تـليثون العـرب - Telethon-iqqhtanie ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"𖤍︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @rickthon :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث ريك ثون انتضر من 5 دقائق")
    try:
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**𖤍︙  📑 يرجى متابع قناه الفارات تجدها هنا : @rickthon")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlinerickthon(rickthon):
        ...
        if query.startswith("تنصيب") and rickthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://youtu.be/44tYK_yV02Q"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethon-iqqhtani/generatestringsession#start.sh"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/telethon-iqqhtani/telethohelp"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/LLL5L"),]]
...
( .ايقاف اسم وقتي )
———————×———————
 𖤍︙ يوجد شرح مفصل عن الامر هنا : https://t.me/RICKTHONS/4484
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/RICKTHONS/4483
شرح الأوامر : ( @RICKTHONS ) .
قناه السورس : ( @rickthon ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/RICKTHONS/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/RICKTHONS/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/RICKTHONS/4720  ⦒
""")
