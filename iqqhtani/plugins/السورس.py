...
async def amireallyalive(event):
    ...
    Iqqhtani_ALIVE_TEXT = "❬ ريـك ثون العـرب - RICKThon-Arabe ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"◈︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس ريك ثون @rickthon :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث ريك ثون انتضر من 5 الى 10 دقائق")
    try:
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqqhtani(iqqhtani):
        ...
        if query.startswith("تنصيب") and iqqhtani.query.user_id == bot.uid:
            buttons = [[Button.url("1- "شرح التنصيب"'"https://youtobe.com "), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@saif61/Rick-thon#main.py"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/telethon-Arab/telethohelp"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/x7_cm"),]]
...
( .ايقاف اسم وقتي )
———————×———————
 ◈︙ يوجد شرح مفصل عن الامر هنا : https://t.me/rickthons/24
""")
...
https://t.me/rickthons/25
  • لتغير صوره او فيديو امر الفحص اضغط هنا ↶
https://t.me/rickthons/8
  • لتغير كليشة امر حماية الخاص اضغط هنا ↶
https://t.me/rickthons/29
  • لوضع صوره او فيديو حماية الخاص اضغط هنا ↶
https://t.me/rickthons/30
  • لتغير عدد تحذيرات حماية الخاص اضغط هنا ↶
https://t.me/rickthons/31
  • لتغير نبذه الوقتيه اضغط هنا ↶
https://t.me/rickthons/32
  • لتغير صوره وقتيه اضغط هنا ↶
 https://t.me/rickthons/33
  • لتغير خط زخرفه اسم وقتي اضغط هنا ↶
 https://t.me/rickthons/34
  •  لوضع ايموجي بجانب اسم وقتي اضغط هنا ↶
 https://t.me/VFF34/37
• لتغير امر من الاوامر اضغط هنا ↶
https://t.me/rickthons/354
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/rickthons/36
———————×———————
قناه المتغيرات او الفارات : @rickthons
شرح الأوامر : ( @rickthons ) .
قناه السورس : ( @rickthon ) .
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/rickthons/4704
قناه السورس : ( @rickthon ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
الشرح : يقوم بأطفاء الكوبرا بعدد الثواني الي ضفتها  عندما تخلص الثواني سيتم اعاده تشغيل سورس ريك ثون
———————×———————
الأمر ⦙ ( .الاوامر )
