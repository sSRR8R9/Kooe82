...
AFK_ = AFK()
@rickthon.iq_cmd(outgoing=True, edited=False)
...
@rickthon.iq_cmd(    incoming=True, func=lambda e: bool(e.mentioned or e.is_private), edited=False)
...
@rickthon.iq_cmd(    pattern=f"{sleeping}(?:\s|$)([\s\S]*)",)
async def _(event):
    AFK_.USERAFK_ON = {}
    AFK_.afk_time = None
