...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "تخزين سورس ريك ثون العام", iqqhtani, Config.TG_BOT_USERNAME, descript        )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين سورس ريك ثون الخاص", iqqhtani, Config.TG_BOT_USERNAME, descript        )
