...
@rickthon.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@rickthon.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@rickthon.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
